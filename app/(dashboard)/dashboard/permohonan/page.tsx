...
const [previewMimeType, setPreviewMimeType] = useState<string | null>(null)
  ...
  const t: any = {
    ...
    flightData: language === "id"
      ? "Data Penerbangan"
      : "Flight Data",
    patientData: language === "id"
      ? "Data Pasien"
      : "Patient Data",
    patientCondition: language === "id"
      ? "Kondisi Pasien"
      : "Patient Condition",
    companionData: language === "id"
      ? "Data Pendamping"
      : "Companion Data",
    uploadDocuments: language === "id"
      ? "Upload Dokumen"
      : "Upload Documents",

    /* Data Penerbangan */
    serviceType: language === "id"
      ? "Jenis Layanan"
      : "Service Type",
    aircraftType: language === "id"
      ? "Jenis Pesawat"
      : "Aircraft Type",
    ...
    submit: language === "id"
      ? "Submit"
      : "Submit",
    serviceTypePlaceholder: language === "id"
      ? "Pilih jenis layanan"
      : "Select service type",
    departure: language === "id"
      ? "Keberangkatan"
      : "Departure",
    arrival: language === "id"
      ? "Kedatangan"
      : "Arrival",
    aircraftTypePlaceholder: language === "id"
      ? "Pilih jenis pesawat"
      : "Select aircraft type",
    commercial: language === "id"
      ? "Komersial"
      : "Commercial",
    privateJet: language === "id"
      ? "Pribadi"
      : "Private Jet",
    groundhandlingName: language === "id"
      ? "Nama Groundhandling"
      : "Groundhandling Name",
    officerName: language === "id"
      ? "Nama Petugas"
      : "Officer Name",
    officePhone: language === "id"
      ? "No Telepon Kantor"
      : "Office Phone",
    companyEmail: language === "id"
      ? "Email Perusahaan"
      : "Company Email",
    airlineName: language === "id"
      ? "Nama Maskapai"
      : "Airline Name",
    airlineExample: language === "id"      
      ? "Contoh: Garuda Indonesia - PK-GII"
      : "Example: Garuda Indonesia - PK-GII",
    flightNumber: language === "id"
      ? "No Penerbangan"
      : "Flight Number",
    flightExample: language === "id"
      ? "Contoh: GA 330 CGK to KNO"
      : "Example: GA 330 CGK to KNO",
    seatNumber: language === "id"
      ? "No Kursi"
      : "Seat Number",
    seatNote: language === "id"
      ? "Opsional, jika ingin menyertakan nomor kursi pasien"
      : "Optional, if you want to include patient's seat number",
    travelDate: language === "id"
      ? "TanggalPerjalanan"
      : "Travel Date",
    travelTime: language === "id"
      ? "Jam Perjalanan"
      : "Travel Time",

    /* Data Pasien */
    patientName: language === "id"
      ? "Nama Pasien"
      : "Patient Name",
    gender: language === "id"      
      ? "Jenis Kelamin"
      : "Gender",
    tanggalLahir: language === "id"
      ? "Tanggal Lahir"
      : "Date of Birth", 

      /* Kondisi Pasien */
    memerlukanOksigen: language === "id"
      ? "Memerlukan Oksigen"
      : "Requires Oxygen",
    posisiPasien: language === "id"
      ? "Posisi Pasien"
      : "Patient Position",
    tingkatKesadaran: language === "id"
      ? "Tingkat Kesadaran"
      : "Level of Consciousness",
    tekananDarah: language === "id"
      ? "Tekanan Darah"
      : "Blood Pressure",
    tekananDarahExample: language === "id"
      ? "Contoh: 120/80 mmHg"
      : "Example: 120/80 mmHg",
    nadiExample: language === "id"
      ? "Contoh: 80 bpm"
      : "Example: 80 bpm",
    FrekuensiNafasExample: language === "id"
      ? "Contoh: 16 bpm"
      : "Example: 16 bpm",
    saturasiOksigenExample: language === "id"
      ? "Contoh: 98%"
      : "Example: 98%",
    tingkatKesadaranExample: language === "id"
      ? "Contoh: skor 3-15"
      : "Example: score 3-15",
    nadi: language === "id"
      ? "Nadi"
      : "Pulse",
    frekuensiNafas: language === "id"
      ? "Frekuensi Nafas"
      : "Respiratory Rate",
    saturasiOksigen: language === "id"
      ? "Saturasi Oksigen"
      : "Oxygen Saturation",

    /* Data Pendamping */
    jumlahPendamping: language === "id"
      ? "Jumlah Pendamping"
      : "Number of Companions",
    hubungandenganPasien: language === "id"
      ? "Hubungan dengan Pasien"
      : "Relationship to Patient",
    nomorTeleponPendampingMedis: language === "id"
      ? "Nomor Telepon Pendamping Medis"
      : "Medical Companion Phone Number",
    nomorTeleponKeluarga: language === "id"
      ? "Nomor Telepon Keluarga"
      : "Family Phone Number",
    nosuratIzin: language === "id"
      ? "No Surat Izin Praktik "
      : "Permit Letter Number",
    namaPendamping: language === "id"
      ? "Nama Pendamping"
      : "Companion Name",
    ...
    {/* Jenis Layanan */}
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) =>
            updateField("noTelepon", e.target.value)
          }
          className="mt-1.5"
        />
      </div>
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) =>
            updateField("noKursi", e.target.value)
          }
          className="mt-1.5"
        />
        <p className="text-xs text-gray-500 mt-1">
        ...
        <div>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              ...
              {/* Memerlukan Oksigen */}
              <div>
                <Label htmlFor="memerlukanOksigen"
                  className="text-sm text-gray-700"
                >
                  {t.memerlukanOksigen}
                </Label>
              ...
              {/* Tingkat Kesadaran */}
              <div>
                <Label htmlFor="tingkatKesadaran"
                  className="text-sm text-gray-700"
                >
                  {t.tingkatKesadaran}
                </Label>
          ...
          {currentStep === 4 && (
            <div>
              ...
              {/* Jumlah Pendamping */}
              <div>
                <Label htmlFor="jumlahPendamping"
                  className="text-sm text-gray-700"
                >
                  {t.jumlahPendamping}
                </Label>
              ...
              {/* Hubungan dengan Pasien */}
              <div>
                <Label htmlFor="hubunganPendamping"
                  className="text-sm text-gray-700"
                >
            ...
            {/* Nomor Telepon Pendamping Medis */}
            <div>
              <Label htmlFor="nomorTeleponPendampingMedis"
                className="text-sm text-gray-700"
              >
            ...
            {/* Nomor Telepon Keluarga */}
            <div>
              <Label htmlFor="nomorTeleponKeluarga"
                className="text-sm text-gray-700"
              >
